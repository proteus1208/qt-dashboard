...
{
    //Use Qt native method without any processing
    ...
    for (int i = 0; i < count - 1; ++i) {
        //The x coordinate of the control point is half of the sum of the x coordinates of sp and ep
        //The y coordinate of the first control point c1 is the y coordinate of the starting point sp
        //The y coordinate of the second control point c2 is the y coordinate of the end point ep
