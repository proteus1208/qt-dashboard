...
void LightButton::paintEvent(QPaintEvent *)
{
    ...
    //Draw preparation work, enable anti-aliasing, translate the center of the coordinate axis, and scale proportionally
    ...
    if (showRect) {
        ...
        //Draw the internal indicator color
        drawBg(&painter);
        //Draw centered text
        drawText(&painter);
        //Draw the mask layer
...
void LightButton::drawOverlay(QPainter *painter)
{
    ...
    //The shape of the highlight is the small circle buckle off the big circle part
